...
module.exports = function ({
	...
	return {
		...
		cache: ({mappedTrack, mappedDetection, index}) => {
			...
			// Console.log('mahalanobis track predicted is', predicted.mean, 'mappedDetection[varianceKey]', mappedDetection[varianceKey], {mappedDetection, index})
